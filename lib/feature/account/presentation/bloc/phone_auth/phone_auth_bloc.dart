...
class PhoneAuthBloc extends BaseBloc<PhoneAuthEvent, PhoneAuthState> {
  ...
  PhoneAuthBloc({
    ...
    on<PhoneAuthAuthNumRequested>(_onAuthNumRequested);
    on<PhoneAuthAuthNumInputted>(_onAuthNumInputted);
  }
}

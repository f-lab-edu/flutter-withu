...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(status: $status, message: $message, loginId: $loginId, isValidId: $isValidId, password: $password, isValidPassword: $isValidPassword, isVisiblePassword: $isVisiblePassword, isEnabledLogin: $isEnabledLogin, selectedTab: $selectedTab)';
  }

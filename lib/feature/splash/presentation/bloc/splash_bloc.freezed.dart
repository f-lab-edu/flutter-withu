...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BaseBlocStatus status, String message, bool isLoggedIn});
}
...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl(
      {required this.status, this.message = '', this.isLoggedIn = false});
  ...
  @override
  String toString() {
    return 'SplashState(status: $status, message: $message, isLoggedIn: $isLoggedIn)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, message, isLoggedIn);
